...
public class RankedRetrieval {
    ...
    public RankedRetrieval(Indexer indexer, Tokenizer tokenizer, 
            ScoringAlgorithm scoringAlgorithm, int nDocs, List<Vector> vectors,
            Map<String, Integer> documentsFrequency, CosineScore score) {
        ...
        this.documentsFrequency = documentsFrequency;
        this.score = score;
    }
    ...
    public void retrieve(int queryID, String queryText) {
        ...
        for (Map.Entry<String, Double> pair : temp.entrySet()) {
            ...
            if (documentsFrequency.containsKey(pair.getKey())) {
                int docFreq = documentsFrequency.get(pair.getKey());
